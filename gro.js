    ...
    xhttp.onreadystatechange = function(){
        ...
        if(this.readyState==4&&this.status==200){
            ...
            for (var i = 0; i < Jgrocery.length; i++) {
              ...
              document.getElementById("ghead").innerHTML = ohead;
              document.getElementById("glist").innerHTML = output;
        }
    }
    ...
    function change() {
        ...
        for (var i = 0; i < length; i++) {
          if (check[i].checked) {
            ...
            s1[i].style.backgroundColor = "aquamarine";
            s2[i].style.backgroundColor = "aquamarine";
            s3[i].style.backgroundColor = "aquamarine";
            s4[i].style.backgroundColor = "aquamarine";
            s5[i].style.backgroundColor = "aquamarine";
            s6[i].style.backgroundColor = "aquamarine";
            s7[i].style.backgroundColor = "aquamarine";
      ...
      document.querySelector("table").addEventListener("click", change);